...
#     parser.add_argument('--rank', type=int, default=4)
    ...
    parser.add_argument('--batch-size', type=int, default=256)     #8 16 32 64 128 256 512 
    ...
    parser.add_argument('--data-path', type=str, default="./flower_data/oxford-102-flowers")
